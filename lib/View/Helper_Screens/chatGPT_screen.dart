import 'dart:async';
import 'package:allohuggy/View/Helper_Screens/ChatMessage.dart';
...
class ChatGPTScreenNew extends StatefulWidget {
  const ChatGPTScreenNew({
    Key ? key
  }): super(key: key);
  @override
  State < ChatGPTScreenNew > createState() => _ChatScreenState();
}
class _ChatScreenState extends State < ChatGPTScreenNew > {
